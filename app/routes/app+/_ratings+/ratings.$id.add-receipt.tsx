    ...
    const rating = await dbQuery.rating.findUnique({
      ...
      const updatedRating = await dbQuery.rating.update({
       ...
       receipt: receiptDoc.id
        ...
        include: { receiptModel: true, invoiceModel:true, clientModel:{
    ...
    useEffect(() => {
      ...
      const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!fileInput.files || fileInput.files.length === 0) {
          ...
          alert("Please select a receipt file before clicking on the upload button");
        }
      };
        ...
        <div className="fixed inset-0 flex items-center justify-center">
              <div className="relative modal-box">
                ...
                >
                  ...
                  <input type="file" name="receipt" id="receipt" accept=".pdf" required/>
                  <button
                    type="submit"
